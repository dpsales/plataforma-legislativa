...
ROOT_URLCONF = "busca_comissoes_mistas.urls"
...
WSGI_APPLICATION = "busca_comissoes_mistas.wsgi.application"
...
CELERY_TASK_DEFAULT_QUEUE = os.getenv("CELERY_TASK_DEFAULT_QUEUE", "busca_comissoes_mistas")
