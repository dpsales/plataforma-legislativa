...
ROOT_URLCONF = "busca_comissoes_cd.urls"
...
WSGI_APPLICATION = "busca_comissoes_cd.wsgi.application"
...
CELERY_TASK_DEFAULT_QUEUE = os.getenv("CELERY_TASK_DEFAULT_QUEUE", "busca_comissoes_cd")
...
if _force_script_name:
    ...
    if FORCE_SCRIPT_NAME:
        if not STATIC_URL.startswith(FORCE_SCRIPT_NAME):
            STATIC_URL = f"{FORCE_SCRIPT_NAME}{STATIC_URL if STATIC_URL.startswith('/') else '/' + STATIC_URL}"
